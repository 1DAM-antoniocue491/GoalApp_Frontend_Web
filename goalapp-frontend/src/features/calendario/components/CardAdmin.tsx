...
export default function CardAdmin({ isadmin, onCreateCalendar, onCreateMatch }: CardAdminProps) {
  if (!isadmin) {
    return (
  ...
  return (
    <div className="w-full mt-8 mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
          ...
          <div>
            <div className="flex justify-between items-start mb-6">
              <div className="bg-gray-800/50 w-12 h-12 rounded-xl flex items-center justify-center">
                <FaCalendar className="text-[#c5f52a] text-2xl" />
              </div>
            </div>
        ...
        <div className="bg-[#1a1a1e] border border-gray-800 p-8 rounded-3xl flex flex-col justify-between shadow-xl">
          <div>
