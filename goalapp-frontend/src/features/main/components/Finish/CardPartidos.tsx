...
export default function CardPartidos({fecha,resultado,equipo1,equipo2,goles1,goles2}:Partidos) {
            ...
            {(() => {
                ...
                <>
                    ...
                    <div className="w-full flex justify-between items-center px-2">
                        ...
                        <span className="absolute left-1/2 -translate-x-1/2 text-[10px] text-gray-500 font-bold uppercase tracking-[0.2em]">Goles</span>
                        <div className="w-[72px]"></div> {/* Espaciador para mantener el centro */}
                    </div>
                    )}
                    ...
                    {g2 > g1 && (
                    <div className="w-full flex justify-between items-center px-2">
                        <div className="w-[72px]"></div> {/* Espaciador */}
                        <span className="absolute left-1/2 -translate-x-1/2 text-[10px] text-gray-500 font-bold uppercase tracking-[0.2em]">Goles</span>
                        <div className="flex items-center gap-1.5 bg-lime-400/10 px-2 py-1 rounded-md border border-lime-400/20">
                        <span className="text-[10px] text-lime-400 font-black uppercase">Ganador</span>
                        <span className="text-[10px]">🏆</span>
