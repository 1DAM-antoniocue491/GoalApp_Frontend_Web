            ...
            >
              ...
              <div className="flex gap-2 mt-3">
                <button
                  ...
                  className={`w-1/2 px-3 py-1.5 text-sm font-bold not-even:rounded-lg transition-colors border-2 ${
                ...
                <button
                  ...
                  className={`w-1/2 px-3 py-1.5 text-sm font-bold rounded-lg transition-colors border-2 ${
