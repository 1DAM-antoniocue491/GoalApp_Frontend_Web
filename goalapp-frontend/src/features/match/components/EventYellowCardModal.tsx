...
export default function EventYellowCardModal({
  isOpen,
  onClose,
  onConfirm,
  localTeam,
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-[#1a1a1e] border border-gray-800 rounded-2xl w-full max-w-md overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-yellow-900/80 to-black p-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-yellow-500 flex items-center justify-center">
                <FaExclamationTriangle className="text-black text-sm" />
              </div>
              <div>
                <h2 className="text-white text-xl font-bold">Tarjeta Amarilla</h2>
                <p className="text-gray-400 text-xs">Registrar amonestación</p>
              </div>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="p-6 space-y-5">
          ...
          <div>
            <label className="text-gray-300 text-sm font-medium mb-2 block">
              Equipo <span className="text-yellow-400">*</span>
            </label>
          ...
          <div>
            <label className="text-gray-300 text-sm font-medium mb-2 block">
              Jugador <span className="text-yellow-400">*</span>
            </label>
            <select
              value={selectedPlayer || ''}
              onChange={(e) => setSelectedPlayer(Number(e.target.value))}
              disabled={!selectedTeam}
              className="w-full px-4 py-3 rounded-xl bg-gray-800/50 border border-gray-700 text-gray-300 focus:border-yellow-500 focus:outline-none focus:ring-1 focus:ring-yellow-500 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <option value="">
          ...
          <div>
            ...
            >
              ...
              <option value="Entrada temeraria">Entrada temeraria</option>
              <option value="Protestar">Protestar al árbitro</option>
              <option value="Perder tiempo">Perder tiempo</option>
              <option value="Falta táctica">Falta táctica</option>
              <option value="Quitar gol con mano">Quitar gol con la mano</option>
        ...
        <div className="flex gap-3 p-6 border-t border-gray-800">
          ...
          <button
            ...
            className="flex-1 bg-yellow-600 text-black font-bold py-3 rounded-xl hover:bg-yellow-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
